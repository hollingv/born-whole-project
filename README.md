...
- **Organizations** — if you run an advocacy organization in this space, you can register your site by submitting a pull request to add your details to `src/cmd/gacli/organizations.go`. Following a consistent URL structure (e.g. `/about`, `/research`, `/legal-cases`) ensures your content is automatically included in the knowledge base and surfaced through the Ask feature.
...
- **Researchers and writers** — contributions to the FAQ (`src/cmd/gacli/faq.go`) and knowledge base sources help improve the accuracy and depth of answers provided to the public.
